...
<?php
    ...
    if(isset($_GET['q']) AND !empty($_GET['q'])){
        ...
        $article = $bdd->query('SELECT product_name FROM product WHERE product_name LIKE "%'.$q.'%" ORDER BY id_product DESC');
                ...
                <div class="container">
                    <nav class="nav">
                                ...
                                <li class="nav_item">
                                    <li class="dropdown">
                                        ...
                                        <div class="dropdown_content">
                                            <a  href="scie.php" >SAW</a>
                                            <a  href="sanders.php">SANDERS</a>
                                            <a  href="screwdriver.php">SCREWDRIVER</a>
                                            <a  href="pliers.php">PLIERS</a>
                                            <a  href="wrench.php">WRENCH</a>
                                            <a  href="box.php">BOX TOOLS</a>
                                        </div>
                                    </li>
                        ...
                        <div class="nav_icons">
                            ...
                            <form methode="GET" style="display:flex;margin-right:10px;">
                                <input type="search" name="q" id="" placeholder="Search..." style="margin-right:10px;border-radius:1cm;width:250px;height:35px;font-size:15px;">
                                <button type="submit" class="icon_item">
                                    <svg><use xlink:href="./image/sprite.svg#icon-search"></use></svg>
                                </button>    
                            </form>
                            <!-- --------------------------------------- -->
                ...
                <section class="category_section section" id="category">
                    <div class="tab_list">
                        <div class="title_container tabs">
                            ...
                            <div class="section_titles category_titles">

                                <div class="section_title_cat filter_btn active" data-id="All Products" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="2000">
                                    <span class="dot_cat"></span>
                                        <h1 class="primary_title">All products</h1>
                                </div>
                            </div>

                            <div class="section_titles">
                                <div class="section_title_cat filter_btn active" data-id="saw" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="1200">
                                    <span class="dot_cat"></span>
                                        <h1 class="primary_title">SAW</h1>
                                </div>
                            </div> 
                            <div class="section_titles">
                                <div class="section_title_cat filter_btn active" data-id="sanders" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="1200">
                                    <span class="dot_cat"></span>
                                        <h1 class="primary_title">SANDERS</h1>
                                </div>
                            </div>

                            <div class="section_titles">
                                <div class="section_title_cat filter_btn active" data-id="screwdriver" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="1200">
                                    <span class="dot_cat"></span>
                                        <h1 class="primary_title">SCREWDRIVER</h1>
                                </div>
                            </div>
                            <div class="section_titles">
                                <div class="section_title_cat filter_btn active" data-id="pliers" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="1200">
                                    <span class="dot_cat"></span>
                                        <h1 class="primary_title">PLIERS</h1>
                                </div>
                            </div>
                            <div class="section_titles">
                            ...
                            <div class="section_titles">
                                <div class="section_title_cat filter_btn active" data-id="box" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="1200">
                                    <span class="dot_cat"></span>
                                        <h1 class="primary_title">BOX TOOLS</h1>
                                </div>
                            </div>
                        </div>
