                ...
                <div class="container">
                    <nav class="nav">
                        ...
                        <div class="nav_logo">
                            ...
                            <a href="index.html" class="scroll-link">Electro Tools</a>
                                ...
                                <li class="nav_item">
                                    <li class="dropdown">
                                        ...
                                        <div class="dropdown_content" id="dropdown_container">
                                            <a  href="scie.html" class="dropdown_element" >SAW</a>
                                            <a  href="sanders.html" class="dropdown_element" >SANDERS</a>
                                            <a  href="screwdriver.html" class="dropdown_element" >SCREWDRIVER</a>
                                            <a  href="pliers.html" class="dropdown_element">PLIERS</a>
                                            <a  href="wrench.html" class="dropdown_element" >WRENCH</a>
                                            <a  href="box.html" class="dropdown_element" >BOX TOOLS</a>
                                        </div>    
                                    </li>
                                </li>
                    ...
                    <div class="tab_list">
                        ...
                        <div class="category_container" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="12000">
                            ...
                            <?php while($produit = $requser->fetch(PDO::FETCH_ASSOC)){ ?>
                                    <?php if($produit['product_cat'] === "pliers"){?>
