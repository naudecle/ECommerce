                    ...
                    <nav class="nav">
                        ...
                        <div>
                            <ul class="nav_list">
                                ...
                                <li class="nav_item">
                                    <li class="dropdown">
                                        ...
                                        <div class="dropdown_content" id="dropdown_container">
                                            <a  href="#" class="dropdown_element" >SAW</a>
                                ...
                                <li class="nav_item">
                                    <a href="index.php #blog" class="nav_link">Blog</a>
                                </li>
                                <li class="nav_item">
                                    <li class="dropdown">
                        ...
                        <div class="nav_icons">
                            <input type="text" name="" id="" placeholder="Searcher..." style="margin-right:10px;border-radius:1cm;">
                    ...
                    <div class="tab_list">
                        <div class="title_container tabs">
                            ...
                            <div class="section_titles" >
                                <div class="section_title_cat filter_btn active" data-id="saw">
                        ...
                        <div class="category_container" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="12000">
                            <div class="category_center">
                                ...
                                <?php while($produit = $requser->fetch(PDO::FETCH_ASSOC)){ ?>
                                    <?php if($produit['product_cat'] === "saw"){?>
